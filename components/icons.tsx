...
export const FileAudioIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <path d="M10 15.5v-3a2.5 2.5 0 0 1 5 0v3"></path>
        <path d="M8 14.5v1"></path><path d="M16 14.5v1"></path>
    </svg>
);
...
export const MarkdownIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="currentColor" viewBox="0 0 16 16">
        <path d="M14 0H2a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2zM5.438 12V5.51h1.443l1.063 2.148 1.063-2.148h1.443V12h-1.443V7.984l-1.063 2.148h-.032L6.88 7.984V12H5.437z"/>
    </svg>
);
